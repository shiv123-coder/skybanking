...
%>
<% request.setAttribute("pageTitle", "Payment Cancelled - SkyBanking"); %>
            ...
            <div class="row justify-content-center mt-5">
                <div class="col-lg-5 col-md-7 text-center">
                    <div class="card border-0 shadow-lg rounded-4 overflow-hidden glass-panel p-5">
                        ...
                        <h2 class="fw-bold text-dark">Payment Cancelled</h2>
                        <p class="text-muted mt-3 mb-4">
                            Your transaction was cancelled and no amount was charged to your card.
                            You can try again whenever you are ready.
                        </p>
                        <a href="addmoney.jsp" class="btn btn-primary btn-lg rounded-pill px-5 py-3 hover-scale shadow fw-bold w-100">
                            Try Again
                        </a>
                        <a href="dashboard" class="btn btn-link text-decoration-none text-muted mt-3">
                            Back to Dashboard
                        </a>
                    </div>
                </div>
